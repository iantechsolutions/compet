...
class EmpalmistaUserScreen extends StatefulWidget {
  const EmpalmistaUserScreen({super.key});

  @override
  HomeScreenState createState() => HomeScreenState();
}

class HomeScreenState extends State<EmpalmistaUserScreen> {
  @override
  void initState() {
    super.initState();
  }
                  ...
                  children: state.instalaciones.map((instalacion) => [
                        ...
                        ShadTableCell(
                            child: ShadButton(
                                ...
                                text: Text(formatDate(instalacion.fechaDeAlta),
                                    style:
